  ...
  return (
    <div className={classes.bg}>
      ...
      {["/transfer", "/nft", "/redeem"].includes(pathname) ? (
        <Container maxWidth="md" style={{ paddingBottom: 24, marginTop: "50px" }}>
          <HeaderText
            white
            subtitle={
              <>
                <Typography>
                  {/* This is a developmental token bridge that tests transfers across chains for tokens and NFTs wrapped by Wormhole. */}
                </Typography>
              </>
            }
          >
