...
export default function TokenPicker({
  ...
  console.log(tokenIdHolderString);

  useEffect(() => {
    // setHolderString(chainId == 2 ? "0x8F3C1BAC313755077f2A7F7135B8Ae15bda0Eaf4" : chainId == 4 ? "0x83ADB07bB91dDDE95A24982F1B2D343963ba3995" : "9kJVtN72tFH1wsCG5tiZjTtGoZHxsLdZH6CEUuSsMkRe")
    if (chainId == 2) setHolderString("0x8F3C1BAC313755077f2A7F7135B8Ae15bda0Eaf4")
    else if (chainId == 4) setHolderString("0x83ADB07bB91dDDE95A24982F1B2D343963ba3995")
    else setHolderString("9kJVtN72tFH1wsCG5tiZjTtGoZHxsLdZH6CEUuSsMkRe");
  }, [chainId])
  console.log(holderString);
