...
export const WORMHOLE_RPC_HOSTS =
  CLUSTER === "testnet"
    ...
    : ["http://localhost:7071"];
export const ETH_NETWORK_CHAIN_ID = CLUSTER === "testnet" ? 1 : 1337;
...
export const SOL_BRIDGE_ADDRESS =
  CONTRACTS[CLUSTER === "testnet" ? "MAINNET" : "DEVNET"].solana.core;
console.log(SOL_BRIDGE_ADDRESS);

export const SOL_NFT_BRIDGE_ADDRESS =
  CONTRACTS[CLUSTER === "testnet" ? "MAINNET" : "DEVNET"].solana.nft_bridge;
export const SOL_TOKEN_BRIDGE_ADDRESS =
  CONTRACTS[CLUSTER === "testnet" ? "MAINNET" : "DEVNET"].solana.token_bridge;
  console.log(SOL_TOKEN_BRIDGE_ADDRESS);

export const ALGORAND_BRIDGE_ID = BigInt(
  CONTRACTS[CLUSTER === "testnet" ? "MAINNET" : "DEVNET"].algorand.core
);
export const ALGORAND_TOKEN_BRIDGE_ID = BigInt(
  CONTRACTS[CLUSTER === "testnet" ? "MAINNET" : "DEVNET"].algorand.token_bridge
);
